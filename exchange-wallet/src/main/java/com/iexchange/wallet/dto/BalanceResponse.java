 ...
 * - totalBalance 总余额
 */
@Schema(name = "BalanceResponse", description = "余额查询响应")
@Data
public class BalanceResponse {
    ...
    public static BalanceResponse ok(Long userId, String asset, BigDecimal available, BigDecimal frozen, BigDecimal total) {
