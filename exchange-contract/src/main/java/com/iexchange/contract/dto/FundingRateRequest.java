 ...
 * 字段说明：
 * - symbol 交易对
 * - markPrice 标记价格（用于强平与资金费率参考）
 * - indexPrice 指数价格（现货指数价/参考价）
 */
@Schema(name = "FundingRateRequest", description = "资金费率计算请求")
@Data
public class FundingRateRequest {
     ...
     * 标记价格。
     */
    @Schema(description = "标记价格（用于强平与资金费率的参考价）", example = "30000")
     ...
     * 指数价格。
     */
    @Schema(description = "指数价格（现货指数价/参考价）", example = "29950")
